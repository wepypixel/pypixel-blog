    ...
    <div className={styles["contact-us-body"]}>
      ...
      <div className={styles["contact-us-content"]}>
        ...
        <p>
          ...
          shared and/or collect in PyPixel. This policy is not applicable to any
        ...
        <p>
          ...
          advertising partners of PyPixel.
        </p>
        ...
        <p>
          Note that PyPixel has no access to or control over these cookies that
        ...
        <p>
          PyPixel&apos;s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          PyPixel does not knowingly collect any Personal Identifiable
